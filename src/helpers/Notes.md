...
const outerOffsetX = width _ outerOffsetXRatio;
const scaledWidth = width _ iconScale;
const scaledHeight = height _ iconScale;
const glyphOffsetX = width _ iconOffsetXRatio;
