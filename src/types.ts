...
export interface PfgChartDef {
	type: 'gauge' | 'bar' | 'bars' | 'history' | 'cycle' | 'group';
	entity?: string;
	entities?: string[];
	value?: number;
	scale?: number;
...
export interface CardConfigEntities {
	...
	battery4_voltage_183: string;
	battery4_soc_184: string;
	battery4_power_190: string;
	battery4_current_191: string;
	battery4_rated_capacity: string;
	battery4_soh: string;
	battery4_temp_182: string;
	battery4_current_direction: string;
	battery4_status: string;
